...
class Texts {
    ...
    public static $NOT_JOINED_START_MESSAGE = "کافیه فقط یک بار امتحان کنی و به جمع بزرگ ما بپیوندی🙂✌️

<a href='http://telegram.me/joinchat/BRw1fj3E1ND9eW5n2zucTQ'>عضـویت در کانال و شروع دریافت جوایز 🏃🏃🏃🏃</a>";

    public static $JOINED_START_MESSAGE = "شما از قبـل در این <a href='http://telegram.me/joinchat/BRw1fj3E1ND9eW5n2zucTQ'>کانال</a> عضو بوده اید✌️


برای شروع دعوت از دوستان و دریافت #شارژ_رایگان ، گزینه ی دریافت لینک را لمس کنید🌸";
...
۱ـ ابتدا در این کانال عضو شویـد 🏃(لینک در پایین) 
...
۳ ـ به ازای هر 20 نفری که شما دعوت میکنید یک شارژ (ایرانسل یا همراه اول) دریافت میکنید 🌼
...
<a href='http://telegram.me/joinchat/BRw1fj3E1ND9eW5n2zucTQ'>عضـویت در کانال و شروع دریافت جوایز</a>";
    ...
    public static $FORWARD_THIS = "این پیام را به دوستـان خود ارسال کنـید،☝️☝️

به ازای هر 20 نفری که با لینک شما وارد ربات شوند و در کانال عضو شوند ...


یک شارژ رایگان دریافت میکنید😱✌️";


    public static function GetUserLink($chat_id){
        global $telegram;
        $text = "شارژ هزار تومانی #رایگان به تعداد #نامحدود 😱👍

به ازای دعوت هر 20 نفر، از طریق لینکی که ربات به شما میدهد، یک شارژ رایگان!


عضو شو ، دعوت کن ، شارژ رایگان بگـیر🏃🌸
